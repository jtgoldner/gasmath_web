...
const SPECS: MockSpec[] = [
  { name: 'Shell — Main St', brand: 'Shell', topTier: true, distanceMiles: 0.6, regular: quote(3.39), premium: quote(4.09) },
  { name: 'ARCO — 5th Ave', brand: 'ARCO', topTier: false, distanceMiles: 0.9, regular: quote(3.05) },
  { name: 'Mobil — Riverside', brand: 'Mobil', topTier: true, distanceMiles: 1.2, regular: quote(3.29), premium: quote(3.99) },
  { name: 'Chevron — Oak Blvd', brand: 'Chevron', topTier: true, distanceMiles: 2.4, regular: quote(3.45, 14), premium: quote(4.15, 14) },
  { name: 'Costco Gasoline', brand: 'Costco', club: 'costco', topTier: true, distanceMiles: 3.1, regular: quote(2.99), premium: quote(3.69) },
  { name: "BJ's Gas", brand: "BJ's", club: 'bjs', topTier: false, distanceMiles: 4.2, regular: quote(3.02) },
  { name: 'Sunoco — Route 9', brand: 'Sunoco', topTier: true, distanceMiles: 5.8, regular: quote(3.19) },
  { name: 'Speedway — Junction', brand: 'Speedway', topTier: false, distanceMiles: 7.5, regular: quote(3.09) },
];
